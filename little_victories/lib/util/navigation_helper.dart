...
class NavigationHelper {
  ...
  static void navigateToPreferencesScreen(
  ...
  // ignore: type_annotate_public_apis, always_declare_return_types
  static void navigateToPushNotificationsScreen(
      BuildContext context,
      User _user) async {
    Navigator.of(context).push(PageRouteBuilder(
        opaque: true,
    ...
    // ignore: type_annotate_public_apis, always_declare_return_types
    static void navigateToHomePageScreen(
        BuildContext context,
        User _user
  ) async {
      Navigator.of(context).push(PageRouteBuilder(
          ...
          transitionDuration: const Duration(milliseconds: 300),
          pageBuilder: (BuildContext context, _, __) {
            return HomePageScreen(user: _user);
          },
          transitionsBuilder: (_, Animation<double> animation, __,
              Widget child) {
            return SlideTransition(
