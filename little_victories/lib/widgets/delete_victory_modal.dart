        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  const BoxShadow(offset: Offset(0, 10),
                      blurRadius: 10
                  ),
                ]
            ),
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  // ignore: prefer_const_literals_to_create_immutables
                  children: <Widget>[
                    const Text('Are you sure you want to delete this Victory?', textAlign: TextAlign.center, textScaleFactor: 1.5,)
                  ],
                ),
                const SizedBox(height: 20),
                Row(
