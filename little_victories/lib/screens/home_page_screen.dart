        ...
        body: SafeArea(
          child: Column(
            ...
            children: <Widget>[
              ...
              Center(child: Text(FirebaseAuth.instance.currentUser!.uid.toString())),
              const Spacer(),
              // Preferences Button
              Container(
                ...
                child: NiceButton(
                    ...
                    onPressed: () {
                      NavigationHelper.navigateToPreferencesScreen(context, _user);
                    }
                ),
              ),
              // View Victories
              Container(
                ...
                child: NiceButton(
                  ...
                  background: CustomColours.darkPurple,
                  onPressed: () => {
                    NavigationHelper.navigateToViewVictoriesScreen(context, _user)
                  },
                ),
              ),
              const Spacer(),
